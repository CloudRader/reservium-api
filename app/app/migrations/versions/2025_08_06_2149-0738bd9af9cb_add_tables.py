...
Revision ID: 0738bd9af9cb
Revises: 
Create Date: 2025-08-06 21:49:06.819925
...
def upgrade() -> None:
    ...
    sa.Column('reservation_service_id', sa.String(), nullable=False),
    sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['reservation_service_id'], ['reservation_service.id'], name=op.f('fk_calendar_reservation_service_id_reservation_service')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_calendar')),
    sa.UniqueConstraint('reservation_type', name=op.f('uq_calendar_reservation_type'))
    )
    ...
    sa.Column('id', sa.String(), nullable=False),
    sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['reservation_service_id'], ['reservation_service.id'], name=op.f('fk_mini_service_reservation_service_id_reservation_service')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_mini_service'))
    )
    op.create_table('calendar_mini_service_association',
    sa.Column('calendar_id', sa.String(), nullable=False),
    sa.Column('mini_service_id', sa.String(), nullable=False),
    sa.Column('id', sa.String(), nullable=False),
    sa.ForeignKeyConstraint(['calendar_id'], ['calendar.id'], name=op.f('fk_calendar_mini_service_association_calendar_id_calendar')),
    sa.ForeignKeyConstraint(['mini_service_id'], ['mini_service.id'], name=op.f('fk_calendar_mini_service_association_mini_service_id_mini_service')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_calendar_mini_service_association')),
    sa.UniqueConstraint('calendar_id', 'mini_service_id', name=op.f('uq_calendar_mini_service_association_calendar_id_mini_service_id'))
    )
    ...
    sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['calendar_id'], ['calendar.id'], name=op.f('fk_event_calendar_id_calendar')),
