...
Revision ID: 19f56c4f5a2b
Revises:
Create Date: 2025-08-15 21:57:25.043818
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["mini_service_id"],
            ["mini_service.id"],
            name=op.f("fk_calendar_mini_service_association_mini_service_id_mini_service"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_calendar_mini_service_association")),
        sa.UniqueConstraint(
            "calendar_id",
            "mini_service_id",
            name=op.f("uq_calendar_mini_service_association_calendar_id_mini_service_id"),
        ),
    )
    op.create_table(
        "event",
        ...
        sa.Column("requested_reservation_start", sa.DateTime(), nullable=True),
        sa.Column("requested_reservation_end", sa.DateTime(), nullable=True),
        ...
        sa.Column(
            "event_state",
            sa.Enum(
                "NOT_APPROVED", "UPDATE_REQUESTED", "CONFIRMED", "CANCELED", name="event_state_enum"
            ),
