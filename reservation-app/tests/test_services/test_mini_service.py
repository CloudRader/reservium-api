...
#     assert mini_service.reservation_service_id == mini_service_create.reservation_service_id
#
#
# @pytest.mark.asyncio
...
#     assert get_mini_service.reservation_service_id == mini_service.reservation_service_id
#
#
# @pytest.mark.asyncio
