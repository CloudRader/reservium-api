...
import pytest
from application.schemas.calendar import CalendarWithReservationServiceInfo
...
from application.schemas.reservation_service import ReservationServiceLite
from application.schemas.user import UserLite
